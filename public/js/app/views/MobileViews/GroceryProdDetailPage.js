define([
    ...
    'views/MobileViews/GroceryProdDetailsView',
    'text!templates/MobileTemplates/FooterView.html',
    'collections/Items',
    'models/Cart'
], function ($, _, Backbone, HeaderView, GroceryProdDetailsView, FooterTemplate, Items, Cart) {
    var HomePageView = Backbone.View.extend({
        ...
        render: function (id) {
            ...
            productDetails.fetch({data: { dataType: "jsonp", "itemid": id, "itemssortBy": "", "site": "MYCITYKART", "city": "BC-PUNE", "limit": 0}, success: function () {
                $(".middleWrapper").html(new GroceryProdDetailsView({model: productDetails.models[0] }).render());
            }});
