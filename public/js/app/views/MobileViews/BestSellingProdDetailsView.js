define([
    ...
    'underscore',
    'backbone',
    'text!templates/MobileTemplates/BestSellingProdDetailsView.html',
    'models/Cart'
    ...
    var HomePageView = Backbone.View.extend({
        ...
        addToCart: function (e) {
            ...
            cartLine.save({"uid": $.cookie('uid'), "cartLines": { "tradeItemId": $(".product_detail_div", this.el).attr("id"), "qty": 1, "unitSellingPrice": $(".product_detail_div", this.el).attr("usp"), "sellerId": $(e.target).attr("sellerid"), "site": "MYCITYKART", "city": "BC-PUNE"}}, {success: function () {
